      ...
      <div className="multisteps-form__panel js-active" data-animation="slideVert">
        <div className="inner pb-0">
          ...
          <div className="wizard-content-item pt-2">
            ...
            <br></br>
            <button type="button" className="btn btn-secundary" data-toggle="modal" data-target="#exampleModal">CLICK HERE FOR THE TEAM CV</button><p></p>
              ...
              <div className="modal-dialog modal-dialog-centered" role="document">
                <div className="modal-content">
                  <div className="modal-header">
                    <h5 className="modal-title" id="exampleModalLabel">Team CV</h5>
