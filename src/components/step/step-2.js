                ...
                <div className="inner pb-100">
                    ...
                    <div className="row">
                        <div className="container d-flex text-center">
                            <div className="col-6"><h5 className="titles">43% of the companies have set their carbon target between 2019 and 2021, hence still in the beginning of the learning curve.
                            </h5>  <img src={require('../../assets/img/status-quo-1.png')} alt="" />
                                {/* <p className="legend">Most companies are setting targets for the first time in the last three years (2019-2021) thus at the beginning of the learning curve.</p> */}
                            </div>
                            <div className="col-6">
                                ...
                                {/* <p className="legend">42% report on both target and progress, and a very limited number of companies unpack Scope 3 separately.</p> */}
                            </div>
                        </div>
                    </div>
                    <div className="row"> 
                        <div className="container d-flex text-center p-5">
                         <div className="col-12"> <h5 className="vermelho"> MOST IMPORTANTLY: Only 6% of the companies report target and progress including scope 3 emissions.</h5> 
                         </div>
                         </div>
                    </div>
