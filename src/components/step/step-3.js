            ...
            <div className="multisteps-form__panel" data-animation="slideVert">
                <div className="inner pb-100">
                    ...
                    <div className="wizard-content-item pt-2">
                        ...
                        <div class="centerimg">  <img class="centerimg" src={require('../../assets/img/t1.png')} alt="" /> </div>
                                        ...
                                        <div class="col-9">
                                            ...
                                            <div class="row selectores">
                                                ...
                                                <label>
                                                    ...
                                                    <input type="radio" name="radio" className="form-control required"/>
                            ...
                            <div className="col-md-12">
                                <div className="n-summary">
                                    <div class="row">
                                        ...
                                        <div class="col-9">
                                            <label>
                                                <input type="radio" name="radio2" className="form-control required" />
